        ...
        <div class="col-lg-6 col-md-6 col-sm-6 p-0 m-0">
            <div class="product-images">
                ...
                <div id="product-image-container" class="main-image mb-3">
                    <img id="product-image" data-zoom-image="{{ asset('uploads/products/' . $product->product_image) }}" src="{{ asset('uploads/products/' . $product->product_image) }}" alt="{{ $product->name }}" class="img-fluid">
                </div>
